...
class AppStore extends Component {
  ...
  getFilteredAppItem = searchResults => {
  ...
  render() {
    ...
    const filteredAppList = this.getFilteredAppItem(searchResults)
    return (
      <div className="bg-cont">
        <div className="content-cont">
          ...
          <ul className="tabItem-list-cont">
          ...
          <ul className="appItem-list-cont">
